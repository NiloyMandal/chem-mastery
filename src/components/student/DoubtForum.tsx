...
import { MessageSquare, ThumbsUp, Tag, Search, PlusCircle, CheckCircle2 } from 'lucide-react';
...
const MOCK_POSTS: Post[] = [
    {
        ...
        content: 'I keep getting confused about when to apply SN1 and when SN2. Is it just about the solvent?',
    ...
    },
    {
        ...
        author: 'Mike Ross',
        content: 'Can someone explain step-by-step how to calculate entropy change for a reversible isothermal process?',
        ...
        <div className="max-w-4xl mx-auto p-6 bg-slate-50 min-h-screen">
            ...
            <div className="flex flex-col md:flex-row justify-between items-center mb-8 gap-4">
                <div>
                    ...
                    <p className="text-slate-500">Ask questions, get answers from peers and teachers.</p>
                </div>
                <button
            ...
            <AnimatePresence>
                {isPosting && (
                    ...
                    >
                        <form onSubmit={handlePost} className="bg-white p-6 rounded-2xl shadow-xl border border-indigo-100">
                            <h3 className="text-lg font-bold text-slate-800 mb-4">Post your Question</h3>
                                ...
                                <div className="flex items-start justify-between mb-2">
                                    <div>
                                        ...
                                        <div className="flex items-center gap-2 text-xs text-slate-500 mt-1">
                                            <span>Posted by <span className="font-medium text-slate-700">{post.author}</span></span>
                                            <span>•</span>
