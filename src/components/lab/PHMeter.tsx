    ...
    return (
        <div className={`flex flex-col items-center ${className}`}>
            ...
            <div className="bg-slate-900 rounded-lg p-3 shadow-xl border border-slate-700">
                <p className="text-[0.5rem] text-slate-400 uppercase tracking-wider mb-1 text-center">pH Meter</p>
                <motion.div
                ...
                <p className="text-[0.5rem] text-slate-400 text-center mt-1">{getLabel(phValue)}</p>
            </div>
