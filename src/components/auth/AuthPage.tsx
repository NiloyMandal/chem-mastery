  ...
  const features = [
    {
      ...
      text: "Virtual Lab Simulations",
    },
    { icon: <Atom className="w-5 h-5" />, text: "3D Molecular Viewer" },
    { icon: <Grid3X3 className="w-5 h-5" />, text: "Periodic Table" },
    { icon: <PenTool className="w-5 h-5" />, text: "Organic Canvas" },
  ];
        ...
        <div className="relative z-10 flex flex-col justify-center px-16 text-white">
          <motion.div
            ...
            <div className="flex items-center gap-3 mb-6">
              ...
              <span className="text-2xl font-bold">ChemManager</span>
            </div>
            ...
            <p className="text-lg text-indigo-100 mb-10 max-w-md">
              Join thousands of students mastering molecular sciences through
              interactive labs and gamified learning.
            </p>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 bg-slate-50">
        <motion.div
          ...
          <div className="lg:hidden p-6 bg-gradient-to-br from-indigo-600 to-purple-600 text-center text-white">
            ...
            <h2 className="text-2xl font-bold">ChemManager</h2>
          </div>
                    ...
                    <div className="grid grid-cols-3 gap-2">
                      {(["STUDENT", "TEACHER", "PARENT"] as const).map((r) => (
                        <button
                          ...
                          type="button"
                          onClick={() => setRole(r)}
                          className={`py-2.5 px-1 rounded-xl text-sm font-semibold capitalize border-2 transition-all ${
                            role === r
            ...
            <div className="mt-8 text-center">
              <div className="relative">
                ...
                <div className="relative bg-white px-4 text-sm text-slate-500">
                  {isLogin ? "New to ChemManager?" : "Already have an account?"}
                </div>
              </div>
              <button
