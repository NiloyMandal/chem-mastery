                        ...
                        <div key={day.day} className="flex flex-col gap-2">
                            ...
                            <div className="space-y-2">
                                {day.slots.map((slot, idx) => (
                                    <div key={idx} className="p-3 bg-indigo-50 border border-indigo-100 rounded-xl hover:shadow-md transition-shadow cursor-pointer group">
                                        <p className="text-xs text-indigo-500 font-bold mb-1">{slot.time}</p>
                                        <p className="font-bold text-slate-800 text-sm group-hover:text-indigo-700">{slot.batch}</p>
