    ...
    return (
        <div className="min-h-screen bg-slate-50 p-6 font-sans">
            <header className="mb-8">
                ...
                <p className="text-slate-500">Track your child&apos;s progress and stay connected.</p>
            </header>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <div className="space-y-6">
                    <div className="bg-white p-6 rounded-2xl shadow-sm border border-slate-200">
                        <h2 className="text-xl font-bold text-slate-800 mb-2">Student Profile</h2>
                        <div className="flex items-center gap-4 mb-4">
                            ...
                            <div>
                                ...
                                <p className="text-slate-500 text-sm">Class {student.class} • {student.stream} Stream</p>
                            </div>
                        </div>
                        <div className="grid grid-cols-2 gap-4 mt-4">
                            ...
                            <div className="bg-green-50 p-3 rounded-lg text-center">
                                <p className="text-xs text-green-600 font-bold uppercase">Avg Score</p>
                    ...
                    <div className="bg-white p-6 rounded-2xl shadow-sm border border-slate-200">
                        ...
                        <div className="space-y-4">
                            <div className="flex gap-3 items-start p-3 bg-slate-50 rounded-lg">
                                ...
                                <div>
                                    <p className="text-sm font-medium text-slate-800">Chemistry Test Results</p>
                            ...
                            <div className="flex gap-3 items-start p-3 bg-slate-50 rounded-lg">
                                ...
                                <div>
                                    <p className="text-sm font-medium text-slate-800">Fee Payment Reminder</p>
