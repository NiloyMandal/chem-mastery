...
export default function ProfilePage() {
  ...
  const [bio, setBio] = useState(
    "Passionate chemistry student exploring the molecular world.",
  );
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                {isEditing ? (
                  ...
                  <p className="text-lg text-slate-900 px-4 py-3 bg-slate-50 rounded-xl">
                    {name}
                  </p>
                )}
              </div>
              ...
              <div>
                ...
                {isEditing ? (
                  ...
                  <p className="text-slate-700 px-4 py-3 bg-slate-50 rounded-xl whitespace-pre-wrap">
                    {bio}
                  </p>
                )}
              </div>
