...
export default function StudentDashboard() {
  ...
  const assignmentTools = TOOLS_DATA.filter((t) => t.section === "assignments");
  const supportTools = TOOLS_DATA.filter((t) => t.section === "support");
        ...
        <div className="relative z-10 p-8 md:p-10 flex flex-col md:flex-row items-center justify-between gap-6 text-white">
          <div>
            ...
            <p className="text-slate-300 mb-6 max-w-md">
              You&apos;re 75% through this module. Complete the final assessment
              to earn your badge.
            </p>

            {/* Progress Bar */}
            <div
              className="w-full max-w-xs bg-white/10 rounded-full h-2 mb-6"
              role="progressbar"
              aria-valuenow={75}
              aria-valuemin={0}
              aria-valuemax={100}>
          ...
          <motion.div
            ...
            <section>
              <h2 className="text-xl font-bold text-slate-800 mb-4 flex items-center gap-2">
                <span
                  className="p-2 bg-gradient-to-br from-emerald-500 to-teal-600 text-white rounded-xl shadow-lg shadow-emerald-500/25"
                  aria-hidden="true">
            ...
            <section>
              <h2 className="text-xl font-bold text-slate-800 mb-4 flex items-center gap-2">
                <span
                  className="p-2 bg-gradient-to-br from-purple-500 to-pink-600 text-white rounded-xl shadow-lg shadow-purple-500/25"
                  aria-hidden="true">
            ...
            <section>
              <h2 className="text-xl font-bold text-slate-800 mb-4 flex items-center gap-2">
                <span
                  className="p-2 bg-gradient-to-br from-blue-500 to-indigo-600 text-white rounded-xl shadow-lg shadow-blue-500/25"
                  aria-hidden="true">
            ...
            <section>
              <h2 className="text-xl font-bold text-slate-800 mb-4 flex items-center gap-2">
                <span
                  className="p-2 bg-gradient-to-br from-purple-500 to-violet-600 text-white rounded-xl shadow-lg shadow-purple-500/25"
                  aria-hidden="true">
...
function StatCard({
  ...
  return (
    <motion.div
      ...
      <div
        className={`w-14 h-14 rounded-2xl bg-gradient-to-br ${gradient} flex items-center justify-center shadow-lg text-white group-hover:scale-110 transition-transform`}
        aria-hidden="true">
        {icon}
      </div>
      <div>
  ...
  return (
    <Link href={href} className="group">
      <motion.div
        ...
        <div
          className={`w-14 h-14 rounded-2xl bg-gradient-to-br ${gradient} flex items-center justify-center shadow-lg group-hover:scale-110 group-hover:rotate-3 transition-all`}
          aria-hidden="true">
          {icon}
        </div>
        <div>
